...
(function (global) {
  ...
  const HELP = {
    ...
    location: {
      ...
      what: 'আপনার প্রধান আয়ের উৎস কোন এলাকায়। ⚠️ এটি **বাসার ঠিকানা নয়** — ' +
        'চাকরি করলে অফিস যেখানে, ব্যবসা হলে ট্রেড লাইসেন্সের ঠিকানা, বাড়ি ভাড়া হলে সেই বাড়ি যেখানে।',
      how: 'পাঁচটি অপশন: Dhaka North City Corporation · Dhaka South City Corporation · ' +
        ...
        'নিচের "কোনটা বাছবেন" অংশে প্রতিটির অধীনে কোন কোন এলাকা পড়ে তার পূর্ণ তালিকা আছে।',
      where: 'অফিসের ঠিকানা বা ট্রেড লাইসেন্সের ঠিকানা দেখে ঠিক করুন। নিশ্চিত না হলে ' +
        '**হোল্ডিং ট্যাক্সের রসিদ** দেখুন — তাতে কোন সিটি কর্পোরেশন বা পৌরসভা লেখা থাকে। ' +
        'সীমানা মাঝেমধ্যে বদলায়, তাই পুরনো ধারণায় না গিয়ে কাগজ দেখে নেওয়াই নিরাপদ।',
